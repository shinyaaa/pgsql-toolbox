...
# -*- coding: utf-8 -*-
"""
internals/docs/json_table_plan/ の全 HTML ページを生成するビルドスクリプト。
...
SITE_TITLE = "PostgreSQL JSON_TABLE PLAN の内部構造"
VERSION_INFO = "PostgreSQL 20devel · d15a6bc2e16 · 2026-07-15 00:51"
FOOTER = ("The Internals of PostgreSQL 風・内部構造解説 / "
          "対象: PostgreSQL 20devel · shinyaaa/postgres")
